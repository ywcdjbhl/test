...
public class Test538auth4fadada {
    private static String APP_ID = "401595";
    private static String APP_SECRET = "vQflzlKSwZQ2qFMgyYE89Nse";
    private static String V = "2.0";
    private static String HOST = "https://testapi.fadada.com:8443/api/";

    private String customer_name;
    private String id_card = "131081199011171016";// 身份证号码;
    ...
    public void regAccount(){
        ...
        response.append("注册账号:");
        response.append("\nAPP_ID:").append(APP_ID);
        response.append("\nAPP_SECRET:").append(APP_SECRET);
        response.append("\nopen_id:").append(transaction_id);
    ...
    public void getAuthCompanyurl(){
        ...
        String result = comverify.invokeCompanyVerifyUrl(companyInfo,bankInfo,legalInfo
            ...
            company_principal_type,return_url,notify_url, null, null);
        response.append("\n").append(result);
    ...
    public void getAuthPersonurl(){
        ...
        String result = personverify.invokePersonVerifyUrl(customer_id,verifyed_way,
            ...
            customer_ident_no,mobile,ident_front_path, null, null);
        response.append("\n").append(result);
        String data = JSON.parseObject(result).getString("data");
        if (null !=data){
            String url = JSON.parseObject(data).getString("url");
    ...
    public void addSignature1(){
        StringBuffer response = new StringBuffer();
        response.append("印章上传:");
        FddClientBase base = new FddClientBase(APP_ID,APP_SECRET,V,HOST);
        File imgfile = new File("F://sings.jpg");
        String result = base.invokeaddSignature("CB3B01356565DA72F3322FF685BFE4DA",imgfile, "");
        response.append("\nresult").append(result);
        System.err.println(response);
    }
    ...
    public void customSignature(){
        StringBuffer response = new StringBuffer();
        response.append("自定义印章:");
        FddClientBase base = new FddClientBase(APP_ID,APP_SECRET,V,HOST);
        String customer_id ="CB3B01356565DA72F3322FF685BFE4DA";
        String content ="印章内容自定义印章内容自定义印章内容自定义印章内容自定义印章内容自定义";
...
//        dynamic2.put("keyword", "");
    ...
    @Test
    public void testgetAuthCompanyurl() {
        getAuthCompanyurl();
    }

    @Test
    public void testaddSignature1() {
        addSignature1();
    }
