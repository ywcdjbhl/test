...
public class Test177 {
	public Object run(Object obj, InvocationService invo) {
...
//				buffer.append("@Override\n");
			...
			// try catch
			buffer.append("try {\n");
			buffer.append("Method met = obj.getClass().getMethod( "+ "\" "+ method.getName() + paramTypeStr + "\"" + ");\n");
			buffer.append("this.invo.daili(this, met);\n");
		...
		buffer2.append("public class " + clazz.getSimpleName() + "Proxy {\n\n");
		// invoservice
	...
	public static void main(String[] args) {
		Test177 test = new Test177();
		Test177_2 test2 = new Test177_2();
		Object obj = test.run(test2, null);
		System.out.println(obj);
	}
}
class Test177_2 {
	PrintStream err = System.err;
	public Test177_2 play(Boolean boo) {
		err.println("play(Boolean boo)");
		return null;
	}
	
	public Test176 playBaseketBall(Test177_2 test, Test177_2 test2) {
		err.println("playBaseketBall(Test177_2 test, Test177_2 test2)");
		return null;
	}
	public void playVolloball(Test176 test, double d, boolean s, String str) {
		err.println("playVolloball(Test176 test, double d, boolean s, String str)");
	}
	public float playRoll() {
		err.println("playRoll()");
		return 1F;
	}
	double playSki() {
		err.println("playSki()");
	...
	protected char playPoker() {
		err.println("playPoker()");
		return ' ';
	}
	private void privateMethod() {}
	
	public HttpServletResponse playBaseketBallList(Test177_2 test, Test177_2 test2) {
		err.println("playBaseketBallList(Test177_2 test, Test177_2 test2)");
		return null;
	}
	public HttpServletResponse playBaseketBallList(Test177_2 test, double d) {
		err.println("playBaseketBallList(Test177_2 test, double d)");
		return null;
	}
}
