...
public class Test241 {
	public static void main(String[] args) {
		Test241CharacterData data = Test241CharacterData.of(11);
		System.out.println(data.getClass().getName());
		data = Test241CharacterData.of(255);
		System.out.println(data.getClass().getName());
		data = Test241CharacterData.of(256);
		System.out.println(data.getClass().getName());
		data = Test241CharacterData.of(131071);
		System.out.println(data.getClass().getName());
		data = Test241CharacterData.of(196607);
		System.out.println(data.getClass().getName());
		data = Test241CharacterData.of(983039);
		System.out.println(data.getClass().getName());
		data = Test241CharacterData.of(1048575);
		System.out.println(data.getClass().getName());
		data = Test241CharacterData.of(1114111);
		System.out.println(data.getClass().getName());
		data = Test241CharacterData.of(1179647);
		System.out.println(data.getClass().getName());
	}
}

abstract class Test241CharacterData {
    ...
    static final Test241CharacterData of(int ch) {
        if (ch >>> 8 == 0) {     // fast-path
            return Test241CharacterDataLatin1.instance;
        } else {
            switch(ch >>> 16) {  //plane 00-16
            case(0):
                return Test241CharacterData00.instance;
            case(1):
                return Test241CharacterData01.instance;
            case(2):
                return Test241CharacterData02.instance;
            case(14):
                return Test241CharacterData0E.instance;
            case(15):   // Private Use
            case(16):   // Private Use
                return Test241CharacterDataPrivateUse.instance;
            default:
                return Test241CharacterDataUndefined.instance;
            }
        }
    }
}

class Test241CharacterDataLatin1 extends Test241CharacterData {
 ...
 static final Test241CharacterDataLatin1 instance = new Test241CharacterDataLatin1();
 private Test241CharacterDataLatin1() {};
...
class Test241CharacterData00 extends Test241CharacterData {
 /* The character properties are currently encoded into 32 bits in the following manner:
     1 bit   mirrored property
     4 bits  directionality property
     9 bits  signed offset used for converting case
 ...
 static final Test241CharacterData00 instance = new Test241CharacterData00();
 private Test241CharacterData00() {};
...
class Test241CharacterData01 extends Test241CharacterData {
    /* The character properties are currently encoded into 32 bits in the following manner:
        1 bit   mirrored property
        4 bits  directionality property
        9 bits  signed offset used for converting case
    ...
    static final Test241CharacterData instance = new Test241CharacterData01();
    private Test241CharacterData01() {};
...
class Test241CharacterData02 extends Test241CharacterData {
    /* The character properties are currently encoded into 32 bits in the following manner:
        1 bit   mirrored property
        4 bits  directionality property
        9 bits  signed offset used for converting case
    ...
    static final Test241CharacterData instance = new Test241CharacterData02();
    private Test241CharacterData02() {};
...
class Test241CharacterData0E extends Test241CharacterData {
    /* The character properties are currently encoded into 32 bits in the following manner:
        1 bit   mirrored property
        4 bits  directionality property
        9 bits  signed offset used for converting case
    ...
    static final Test241CharacterData instance = new Test241CharacterData0E();
    private Test241CharacterData0E() {};
...
class Test241CharacterDataPrivateUse extends Test241CharacterData {
    ...
    static final Test241CharacterData instance = new Test241CharacterDataPrivateUse();
    private Test241CharacterDataPrivateUse() {};
}

	


class Test241CharacterDataUndefined extends Test241CharacterData {
    ...
    static final Test241CharacterData instance = new Test241CharacterDataUndefined();
    private Test241CharacterDataUndefined() {};
}
